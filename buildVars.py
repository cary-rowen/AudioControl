...
addon_info = {
	...
	"addon_name": "AudioControl",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary": _("Audio Control"),
	# Add-on description
...
pythonSources = ["addon/globalPlugins/AudioControl.py"]
#pythonSources = [os.path.join("addon", "globalPlugins", "*.py"), os.path.join("addon", "*.py")]
